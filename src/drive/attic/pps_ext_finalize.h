 ...
 * initialized.
 *
 * @retval ::ERROR_OUT_OF_RESOURCES There is a failure to allocate
 * resources required for the operation.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p machine_model is invalid,
 * @p profile is invalid, @p default_float_rounding_mode is invalid, or
 * @p program is NULL.
 */
status_t HSA_API hsa_ext_program_create(
 ...
 * invalid.
 */
status_t HSA_API hsa_ext_program_destroy(
    hsa_ext_program_t program);
 ...
 */
status_t HSA_API hsa_ext_program_add_module(
    hsa_ext_program_t program,
 ...
 * other than ::SUCCESS for a particular iteration, the traversal
 ...
 */
status_t HSA_API hsa_ext_program_iterate_modules(
    hsa_ext_program_t program,
    status_t (*callback)(hsa_ext_program_t program, hsa_ext_module_t module,
                             void* data),
    void* data);
 ...
 */
status_t HSA_API hsa_ext_program_get_info(
    hsa_ext_program_t program,
 ...
 * invalid.
 *
 * @retval ::ERROR_INVALID_ISA @p isa is invalid.
 *
 ...
 */
status_t HSA_API hsa_ext_program_finalize(
    hsa_ext_program_t program,
    hsa_isa_t isa,
...
typedef struct hsa_ext_finalizer_1_00_pfn_s {
  status_t (*hsa_ext_program_create)(
      hsa_machine_model_t machine_model, profile_t profile,
      hsa_default_float_rounding_mode_t default_float_rounding_mode,
      const char *options, hsa_ext_program_t *program);

  status_t (*hsa_ext_program_destroy)(hsa_ext_program_t program);

  status_t (*hsa_ext_program_add_module)(hsa_ext_program_t program,
                                                 hsa_ext_module_t module);

  status_t (*hsa_ext_program_iterate_modules)(
      hsa_ext_program_t program,
      status_t (*callback)(hsa_ext_program_t program,
                               hsa_ext_module_t module, void *data),
      void *data);

  status_t (*hsa_ext_program_get_info)(
      hsa_ext_program_t program, hsa_ext_program_info_t attribute,
      void *value);

  status_t (*hsa_ext_program_finalize)(
