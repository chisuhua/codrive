...
#include "inc/pps_blit_cpdma.h"

namespace hcs {
BlitCpDma::BlitCpDma(core::IQueue* queue)
    : core::IBlit(),
      queue_(queue),
      num_cus_(0) {
...
status_t BlitCpDma::SubmitLinearCopyCommand(void* dst, const void* src,
  ...
  std::vector<core::ISignal*> dep_signals(0);
...
status_t BlitCpDma::SubmitLinearCopyCommand(
    ...
    std::vector<core::ISignal*>& dep_signals, core::Signal& out_signal) {
