...
typedef enum {
  ...
  ERROR = 0x1000,                    // * A generic error has occurred.
  ERROR_INVALID_ARGUMENT = 0x1001,   // * One of the actual arguments does not meet a precondition stated in the
                                                // * documentation of the corresponding formal argument.
  ERROR_INVALID_QUEUE_CREATION = 0x1002,     // * The requested queue creation is not valid.
  ERROR_INVALID_ALLOCATION = 0x1003,         // * The requested allocation is not valid.
  ERROR_INVALID_AGENT = 0x1004,              // * The agent is invalid.
  ERROR_INVALID_REGION = 0x1005,             // * The memory region is invalid.
  ERROR_INVALID_SIGNAL = 0x1006,             // * The signal is invalid.
  ERROR_INVALID_QUEUE = 0x1007,              // * The queue is invalid.
  ERROR_OUT_OF_RESOURCES = 0x1008,           // * The HSA runtime failed to allocate the necessary resources. This error
                                                        // * may also occur when the HSA runtime needs to spawn threads or create
                                                        // * internal OS-specific events.
  ERROR_INVALID_PACKET_FORMAT = 0x1009,      // * The AQL packet is malformed.
  ERROR_RESOURCE_FREE = 0x100A,              // * An error has been detected while releasing a resource.
  ERROR_NOT_INITIALIZED = 0x100B,            // * An API other than ::hsa_init has been invoked while the reference count
                                                        // * of the HSA runtime is 0.
  ERROR_REFCOUNT_OVERFLOW = 0x100C,          // * The maximum reference count for the object has been reached.
  ERROR_INCOMPATIBLE_ARGUMENTS = 0x100D,     // * The arguments passed to a functions are not compatible.
  ERROR_INVALID_INDEX = 0x100E,              // * The index is invalid.
  ERROR_INVALID_ISA = 0x100F,                // * The instruction set architecture is invalid.
  ERROR_INVALID_ISA_NAME = 0x1017,           // * The instruction set architecture name is invalid.
  ERROR_INVALID_CODE_OBJECT = 0x1010,        // * The code object is invalid.
  ERROR_INVALID_EXECUTABLE = 0x1011,         // * The executable is invalid.
  ERROR_FROZEN_EXECUTABLE = 0x1012,          // * The executable is frozen.
  ERROR_INVALID_SYMBOL_NAME = 0x1013,        // * There is no symbol with the given name.
  ERROR_VARIABLE_ALREADY_DEFINED = 0x1014,   // * The variable is already defined.
  ERROR_VARIABLE_UNDEFINED = 0x1015,         // * The variable is undefined.
  ERROR_EXCEPTION = 0x1016,                  // * An HSAIL operation resulted in a hardware exception.
  ERROR_INVALID_CODE_SYMBOL = 0x1018,        // * The code object symbol is invalid.
  ERROR_INVALID_EXECUTABLE_SYMBOL = 0x1019,  // * The executable symbol is invalid.
  ERROR_INVALID_FILE = 0x1020,               // * The file descriptor is invalid.
  ERROR_INVALID_CODE_OBJECT_READER = 0x1021, // * The code object reader is invalid.
  ERROR_INVALID_CACHE = 0x1022,              // * The cache is invalid.
  ERROR_INVALID_WAVEFRONT = 0x1023,          // * The wavefront is invalid.
  ERROR_INVALID_SIGNAL_GROUP = 0x1024,       // * The signal group is invalid.
  ERROR_INVALID_RUNTIME_STATE = 0x1025,      // * The HSA runtime is not in the configuration state.
  ERROR_FATAL = 0x1026                       // * The queue received an error that may require process termination.
} status_t;
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p status is an invalid
 ...
 * @retval ::SUCCESS The function has been executed successfully.
 *
 * @retval ::ERROR_OUT_OF_RESOURCES The HSA runtime failed to allocate
 * the required resources.
 *
 * @retval ::ERROR_REFCOUNT_OVERFLOW The HSA runtime reference
 ...
 */
status_t HSA_API hsa_system_get_info(
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p extension is not a valid
 * extension, or @p name is NULL.
 */
status_t HSA_API hsa_extension_get_name(
    uint16_t extension,
    const char **name);
 ...
 */
status_t HSA_API HSA_DEPRECATED hsa_system_extension_supported(
    uint16_t extension,
 ...
 */
status_t HSA_API hsa_system_major_extension_supported(
    uint16_t extension,
    uint16_t version_major,
    uint16_t *version_minor,
    bool* result);
 ...
 */
status_t HSA_API HSA_DEPRECATED hsa_system_get_extension_table(
    uint16_t extension,
    uint16_t version_major,
    uint16_t version_minor,
    void *table);
 ...
 * extension, or @p table is NULL.
 */
status_t HSA_API hsa_system_get_major_extension_table(
    uint16_t extension,
    uint16_t version_major,
    size_t table_length,
    void *table);    
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_AGENT The agent is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p attribute is an invalid
 * agent attribute, or @p value is NULL.
 */
status_t HSA_API hsa_device_get_info(
    device_t agent,
 ...
 * ::SUCCESS for a particular iteration, the traversal stops and
...
*/
status_t HSA_API hsa_iterate_agents(
    status_t (*callback)(device_t agent, void* data),
    void* data);
...
status_t HSA_API hsa_device_get_info_size(
    device_t agent,
    hsa_agent_info_t attribute,
    size_t* size);
...
// Note: this API will not be in the spec unless needed
status_t HSA_API hsa_agent_set_info(
    device_t agent,
    hsa_agent_info_t attribute,
    void* value);
 ...
 * @retval ::ERROR_INVALID_AGENT The agent is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p profile is not a valid
 * profile, or @p mask is NULL.
 *
 */
status_t HSA_API HSA_DEPRECATED hsa_agent_get_exception_policies(
    device_t agent,
    profile_t profile,
    uint16_t *mask);
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_CACHE The cache is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p attribute is an invalid
 * instruction set architecture attribute, or @p value is
 * NULL.
 */
status_t HSA_API hsa_cache_get_info(
    cache_t cache,
    cache_info_t attribute,
    void* value);
 ...
 * extension, or @p result is NULL.
 */
status_t HSA_API HSA_DEPRECATED hsa_agent_extension_supported(
    uint16_t extension,
    device_t agent,
    uint16_t version_major,
    uint16_t version_minor,
 ...
 * extension, or @p version_minor is NULL, or @p result is NULL.
 */
status_t HSA_API hsa_agent_major_extension_supported(
    uint16_t extension,
    device_t agent,
    uint16_t version_major,
    uint16_t *version_minor,
 ...
 * the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p signal is NULL, @p
 * num_consumers is greater than 0 but @p consumers is NULL, or @p consumers
 * contains duplicates.
 */
status_t HSA_API hsa_signal_create(
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_SIGNAL @p signal is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT The handle in @p signal is 0.
 */
status_t HSA_API hsa_signal_destroy(
    signal_t signal);
...
*/
signal_value_t HSA_API hsa_signal_load_scacquire(
    signal_t signal);

/**
 * @copydoc hsa_signal_load_scacquire
 */
signal_value_t HSA_API hsa_signal_load_relaxed(
    signal_t signal);
 ...
 * @copydoc hsa_signal_load_scacquire
*/
signal_value_t HSA_API HSA_DEPRECATED hsa_signal_load_acquire(
    signal_t signal);
 ...
 *
 */
signal_value_t HSA_API hsa_signal_exchange_scacq_screl(
    signal_t signal,
    signal_value_t value);
 ...
 */
signal_value_t HSA_API HSA_DEPRECATED hsa_signal_exchange_acq_rel(
    signal_t signal,
    signal_value_t value);
 ...
 * @copydoc hsa_signal_exchange_scacq_screl
 */
signal_value_t HSA_API hsa_signal_exchange_scacquire(
    signal_t signal,
    signal_value_t value);
 ...
 */
signal_value_t HSA_API HSA_DEPRECATED hsa_signal_exchange_acquire(
    signal_t signal,
    signal_value_t value);
 ...
 * @copydoc hsa_signal_exchange_scacq_screl
 */
signal_value_t HSA_API hsa_signal_exchange_relaxed(
    signal_t signal,
    signal_value_t value);
/**
 * @copydoc hsa_signal_exchange_scacq_screl
 */
signal_value_t HSA_API hsa_signal_exchange_screlease(
    signal_t signal,
    signal_value_t value);
 ...
 */
signal_value_t HSA_API HSA_DEPRECATED hsa_signal_exchange_release(
    signal_t signal,
    signal_value_t value);
 ...
 *
 */
signal_value_t HSA_API hsa_signal_cas_scacq_screl(
    signal_t signal,
 ...
 */
signal_value_t HSA_API HSA_DEPRECATED hsa_signal_cas_acq_rel(
    signal_t signal,
    signal_value_t expected,
    signal_value_t value);
 ...
 * @copydoc hsa_signal_cas_scacq_screl
 */
signal_value_t HSA_API hsa_signal_cas_scacquire(
    signal_t signal,
    signal_value_t expected,
    signal_value_t value);
 ...
 */
signal_value_t HSA_API HSA_DEPRECATED hsa_signal_cas_acquire(
    signal_t signal,
    signal_value_t expected,
    signal_value_t value);
 ...
 * @copydoc hsa_signal_cas_scacq_screl
 */
signal_value_t HSA_API hsa_signal_cas_relaxed(
    signal_t signal,
    signal_value_t expected,
    signal_value_t value);
 ...
 * @copydoc hsa_signal_cas_scacq_screl
 */
signal_value_t HSA_API hsa_signal_cas_screlease(
    signal_t signal,
    signal_value_t expected,
    signal_value_t value);
 ...
 */
signal_value_t HSA_API HSA_DEPRECATED hsa_signal_cas_release(
    signal_t signal,
    signal_value_t expected,
    signal_value_t value);
 ...
 *
*/
signal_value_t HSA_API hsa_signal_wait_scacquire(
    signal_t signal,
 ...
 */
signal_value_t HSA_API hsa_signal_wait_relaxed(
    signal_t signal,
    signal_condition_t condition,
    signal_value_t compare_value,
    uint64_t timeout_hint,
 ...
 * @copydoc hsa_signal_wait_scacquire
 */
signal_value_t HSA_API HSA_DEPRECATED hsa_signal_wait_acquire(
    signal_t signal,
    signal_condition_t condition,
    signal_value_t compare_value,
    uint64_t timeout_hint,
 ...
 * the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p num_signals is 0, @p signals
 * is NULL, @p num_consumers is 0, @p consumers is NULL, or @p signal_group is
 * NULL.
 */
status_t HSA_API hsa_signal_group_create(
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_SIGNAL_GROUP @p signal_group is invalid.
 */
status_t HSA_API hsa_signal_group_destroy(
    hsa_signal_group_t signal_group);
 ...
 * @retval ::ERROR_INVALID_SIGNAL_GROUP @p signal_group is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p conditions is NULL, @p
 * compare_values is NULL, @p signal is NULL, or @p value is NULL.
 */
status_t HSA_API hsa_signal_group_wait_any_scacquire(
    hsa_signal_group_t signal_group,
 ...
 */
status_t HSA_API hsa_signal_group_wait_any_relaxed(
    hsa_signal_group_t signal_group,
    const signal_condition_t *conditions,
    const signal_value_t *compare_values,
    hsa_wait_state_t wait_state_hint,
...
/**
 * @brief A fixed-size type used to represent ::queue_type_t constants.
 */
 ...
 * @retval ::ERROR_INVALID_AGENT The agent is invalid.
 *
 * @retval ::ERROR_INVALID_QUEUE_CREATION @p agent does not
 * support queues of the given type.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p size is not a power of two,
 * @p size is 0, @p type is an invalid queue type, or @p queue is NULL.
 *
 */
status_t HSA_API hsa_queue_create(
    device_t agent,
    uint32_t size,
    queue_type32_t type,
 ...
 * the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p size is not a power of two, @p
 * size is 0, @p type is an invalid queue type, the doorbell signal handle is
 * 0, or @p queue is NULL.
 *
 */
status_t HSA_API hsa_soft_queue_create(
    region_t region,
    uint32_t size,
    queue_type32_t type,
    uint32_t features,
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_QUEUE The queue is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p queue is NULL.
 */
status_t HSA_API hsa_queue_destroy(
    queue_t *queue);
 ...
 * @retval ::ERROR_INVALID_ARGUMENT @p queue is NULL.
 */
status_t HSA_API hsa_queue_inactivate(
    queue_t *queue);
...
// TODO schi add for packet callback, it can merge with core::IHsaEventCallback in next
...
typedef struct hsa_kernel_dispatch_packet_s {
  ...
  // utils::any *callback;
  // std::function<HsaEventCallback> callback;
...
typedef enum {
  ...
  DMA_D2D,
  DMA_H2H,
  DMA_SUA,      // system unified address
  DMA_DIR_COUNT
} dma_copy_dir;
*/
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_REGION The region is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p attribute is an invalid
 * region attribute, or @p value is NULL.
 */
status_t HSA_API hsa_region_get_info(
    region_t region,
 ...
 * @retval ::ERROR_INVALID_REGION The region is invalid.
 *
 * @retval ::ERROR_INVALID_ALLOCATION The host is not allowed to
 * allocate memory in @p region, or @p size is greater than the value of
 * HSA_REGION_INFO_ALLOC_MAX_SIZE in @p region.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p ptr is NULL, or @p size is 0.
 */
status_t HSA_API hsa_memory_allocate(region_t region,
    size_t size,
    void** ptr);
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_ARGUMENT The source or destination
 * pointers are NULL.
 */
status_t HSA_API hsa_memory_copy(
    void *dst,
    const void *src,
    size_t size);
    // uint8_t dir);
 ...
 * the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p ptr is NULL, or @p access is
 * not a valid access value.
 */
status_t HSA_API hsa_memory_assign_agent(
    void *ptr,
    device_t agent,
 ...
 * the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p size is 0 but @p ptr
 * is not NULL.
 */
status_t HSA_API hsa_memory_register(
    void *ptr,
    size_t size);
 ...
 *
 */
status_t HSA_API hsa_memory_deregister(
    void *ptr,
    size_t size);
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_ISA_NAME The given name does not
 * correspond to any instruction set architecture.
 *
 * @retval ::ERROR_OUT_OF_RESOURCES The HSA runtime failed to
 * allocate the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p name is NULL, or @p isa is
 * NULL.
 */
...
status_t HSA_API hsa_agent_iterate_isas(
    device_t agent,
    status_t (*callback)(hsa_isa_t isa, void *data),
    void *data);
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_ISA The instruction set architecture is
 * invalid.
 *
 * @retval ::ERROR_INVALID_INDEX The index is out of range.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p attribute is an invalid
 * instruction set architecture attribute, or @p value is
 * NULL.
 */
status_t HSA_API HSA_DEPRECATED hsa_isa_get_info(
    hsa_isa_t isa,
 ...
 * invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p fp_type is not a valid
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_WAVEFRONT The wavefront is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p attribute is an invalid
...
status_t HSA_API hsa_isa_iterate_wavefronts(
    hsa_isa_t isa,
    status_t (*callback)(hsa_wavefront_t wavefront, void *data),
    void *data);
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_ISA @p code_object_isa or @p agent_isa are
 * invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p result is NULL.
 */
status_t HSA_API HSA_DEPRECATED hsa_isa_compatible(
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_FILE @p file is invalid.
 *
 * @retval ::ERROR_OUT_OF_RESOURCES The HSA runtime failed to
 * allocate the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p code_object_reader is NULL.
 */
/*
 ...
 * allocate the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p code_object is NULL, @p size
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_CODE_OBJECT_READER @p code_object_reader
 * is invalid.
 */
/*
 ...
 * allocate the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p profile is invalid, or
 * @p executable is NULL.
 */
/*
status_t HSA_API HSA_DEPRECATED hsa_executable_create(
    profile_t profile,
 ...
 * @retval ::ERROR_INVALID_EXECUTABLE The executable is invalid.
 *
 * @retval ::ERROR_FROZEN_EXECUTABLE The executable is frozen.
 *
 * @retval ::ERROR_INVALID_CODE_OBJECT_READER @p code_object_reader
 * is invalid.
 *
 * @retval ::ERROR_INCOMPATIBLE_ARGUMENTS The program code object is
 ...
 * is invalid.
 *
 * @retval ::ERROR_INCOMPATIBLE_ARGUMENTS The code object read by @p
 ...
 * @retval ::ERROR_INVALID_EXECUTABLE The executable is invalid.
 *
 * @retval ::ERROR_VARIABLE_UNDEFINED One or more variables are
 * undefined in the executable.
 *
 * @retval ::ERROR_FROZEN_EXECUTABLE @p executable is already frozen.
 */
/*
 ...
 * @retval ::ERROR_INVALID_EXECUTABLE The executable is invalid.
 *
 * @retval ::ERROR_VARIABLE_ALREADY_DEFINED The variable is
 * already defined.
 *
 * @retval ::ERROR_INVALID_SYMBOL_NAME There is no variable with the
 * @p variable_name.
 *
 * @retval ::ERROR_FROZEN_EXECUTABLE @p executable is frozen.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p variable_name is NULL.
 */
/*
 ...
 * @retval ::ERROR_INVALID_EXECUTABLE The executable is invalid.
 *
 * @retval ::ERROR_INVALID_AGENT @p agent is invalid.
 *
 * @retval ::ERROR_VARIABLE_ALREADY_DEFINED The variable is
 * already defined.
 *
 ...
 * allocate the required resources.
 *
 * @retval ::ERROR_INVALID_EXECUTABLE Executable is invalid.
 *
 * @retval ::ERROR_INVALID_AGENT @p agent is invalid.
 *
 * @retval ::ERROR_VARIABLE_ALREADY_DEFINED The variable is
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_EXECUTABLE @p executable is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p result is NULL.
 */
/*
 ...
 * @retval ::ERROR_INVALID_EXECUTABLE The executable is invalid.
 *
 * @retval ::ERROR_INVALID_SYMBOL_NAME There is no symbol with a name
 * that matches @p symbol_name.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p symbol_name is NULL, or
 * @p symbol is NULL.
 */
/*
status_t HSA_API HSA_DEPRECATED hsa_executable_get_symbol(
    hsa_executable_t executable,
 ...
 * that matches @p symbol_name.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p symbol_name is NULL, or @p
 * symbol is NULL.
 */
/*
...
//   * ::HSA_VARIABLE_ALLOCATION_AGENT. The type of this attribute is device_t.
//   */
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_EXECUTABLE_SYMBOL The executable symbol is
 * invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p attribute is an invalid
 ...
 */
/*
status_t HSA_API HSA_DEPRECATED hsa_executable_iterate_symbols(
    hsa_executable_t executable,
 ...
 * ::SUCCESS, this function returns the same code.
 *
 ...
 * allocate the required resources.
 *
 * @retval ::ERROR_INVALID_CODE_OBJECT @p code_object is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p alloc_callback, @p
 * serialized_code_object, or @p serialized_code_object_size are NULL.
 */
status_t HSA_API HSA_DEPRECATED hsa_code_object_serialize(
 ...
 * allocate the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p serialized_code_object, or @p
 * code_object are NULL, or @p serialized_code_object_size is 0.
 */
status_t HSA_API HSA_DEPRECATED hsa_code_object_deserialize(
    void *serialized_code_object,
    size_t serialized_code_object_size,
    const char *options,
    hsa_code_object_t *code_object);
 ...
 * @retval ::ERROR_INVALID_CODE_OBJECT @p code_object is invalid.
 */
status_t HSA_API HSA_DEPRECATED hsa_code_object_destroy(
    hsa_code_object_t code_object);
 ...
 */
status_t HSA_API HSA_DEPRECATED hsa_code_object_get_info(
    hsa_code_object_t code_object,
 ...
 * @retval ::ERROR_INVALID_CODE_OBJECT @p code_object is invalid.
 *
 * @retval ::ERROR_INCOMPATIBLE_ARGUMENTS @p agent is not compatible
 ...
 */
/*
status_t HSA_API HSA_DEPRECATED hsa_executable_load_code_object(
    hsa_executable_t executable,
    device_t agent,
    hsa_code_object_t code_object,
    const char *options);
 ...
 * @p symbol is NULL.
 */
status_t HSA_API HSA_DEPRECATED hsa_code_object_get_symbol(
    hsa_code_object_t code_object,
    const char *symbol_name,
 ...
 * @p symbol is NULL.
 */
status_t HSA_API HSA_DEPRECATED hsa_code_object_get_symbol_from_name(
    hsa_code_object_t code_object,
    const char *module_name,
    const char *symbol_name,
    hsa_code_symbol_t *symbol);
 ...
 * initialized.
 *
 * @retval ::ERROR_INVALID_CODE_SYMBOL The code symbol is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p attribute is an invalid
 * code symbol attribute, or @p value is NULL.
 */
status_t HSA_API HSA_DEPRECATED hsa_code_symbol_get_info(
 ...
 * @retval ::ERROR_INVALID_ARGUMENT @p callback is NULL.
 */
status_t HSA_API HSA_DEPRECATED hsa_code_object_iterate_symbols(
    hsa_code_object_t code_object,
