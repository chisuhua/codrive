...
/**
 * @brief Enumeration constants added to ::status_t by this extension.
 *
 ...
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p image_format is
 ...
 * image_descriptor with the specified @p access_permission.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p image_descriptor is NULL, @p
 ...
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p image_descriptor is
 * NULL, @p image_data_layout is ::HSA_EXT_IMAGE_DATA_LAYOUT_OPAQUE,
 ...
 * @retval ::ERROR_INVALID_AGENT The agent is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p src_offset is
 ...
 * @retval ::ERROR_INVALID_AGENT The agent is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p src_memory is NULL, or @p
 ...
 * @retval ::ERROR_INVALID_AGENT The agent is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p dst_memory is NULL, or @p
 * image_region is NULL.
 */
 ...
 * @retval ::ERROR_INVALID_AGENT The agent is invalid.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p data is NULL, or @p
 * image_region is NULL.
 */
 ...
 * the required resources.
 *
 * @retval ::ERROR_INVALID_ARGUMENT @p sampler_descriptor is NULL, or
 * @p sampler is NULL.
 */
...
typedef struct hsa_ext_images_1_00_pfn_s {
  ...
  status_t (*hsa_ext_image_get_capability)(
    device_t agent,
    hsa_ext_image_geometry_t geometry,
    const hsa_ext_image_format_t *image_format,
    uint32_t *capability_mask);

  status_t (*hsa_ext_image_data_get_info)(
    device_t agent,
    const hsa_ext_image_descriptor_t *image_descriptor,
    hsa_access_permission_t access_permission,
    hsa_ext_image_data_info_t *image_data_info);

  status_t (*hsa_ext_image_create)(
    device_t agent,
    const hsa_ext_image_descriptor_t *image_descriptor,
    const void *image_data,
    hsa_access_permission_t access_permission,
  ...
  status_t (*hsa_ext_image_destroy)(
    device_t agent,
    hsa_ext_image_t image);

  status_t (*hsa_ext_image_copy)(
    device_t agent,
    hsa_ext_image_t src_image,
    const hsa_dim3_t* src_offset,
    hsa_ext_image_t dst_image,
  ...
  status_t (*hsa_ext_image_clear)(
    device_t agent,
    hsa_ext_image_t image,
    const void* data,
    const hsa_ext_image_region_t *image_region);

  status_t (*hsa_ext_sampler_create)(
    device_t agent,
    const hsa_ext_sampler_descriptor_t *sampler_descriptor,
    hsa_ext_sampler_t *sampler);

  status_t (*hsa_ext_sampler_destroy)(
    device_t agent,
    hsa_ext_sampler_t sampler);
...
typedef struct hsa_ext_images_1_pfn_s {
  ...
  status_t (*hsa_ext_image_get_capability_with_layout)(
    device_t agent,
    hsa_ext_image_geometry_t geometry,
    const hsa_ext_image_format_t *image_format,
    hsa_ext_image_data_layout_t image_data_layout,
  ...
  status_t (*hsa_ext_image_data_get_info_with_layout)(
    device_t agent,
    const hsa_ext_image_descriptor_t *image_descriptor,
    hsa_access_permission_t access_permission,
    hsa_ext_image_data_layout_t image_data_layout,
  ...
  status_t (*hsa_ext_image_create_with_layout)(
    device_t agent,
    const hsa_ext_image_descriptor_t *image_descriptor,
    const void *image_data,
    hsa_access_permission_t access_permission,
