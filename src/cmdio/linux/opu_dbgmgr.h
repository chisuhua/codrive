...
#ifndef OPU_DBGMGR_H_
#define OPU_DBGMGR_H_
...
/*
 * TODO: This definitions to be MOVED to opu_event, once it is implemented.
 *
 ...
 * by the OPU by this mechanism, too.
 */
...
struct HsaEventData {
	...
	/* the following data entries are internal to the OPU & thunk itself */
...
struct opu_dbgdev {
	...
	int (*dbgdev_register)(struct opu_dbgdev *dbgdev);
	int (*dbgdev_unregister)(struct opu_dbgdev *dbgdev);
	int (*dbgdev_address_watch)(struct opu_dbgdev *dbgdev,
				struct dbg_address_watch_info *adw_info);
	int (*dbgdev_wave_control)(struct opu_dbgdev *dbgdev,
