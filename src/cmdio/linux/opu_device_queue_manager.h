...
struct device_queue_manager {
	...
	struct opu_mem_obj	hiq_sdma_mqd;
	bool			sched_running;
};
...
static inline unsigned int get_sh_mem_bases_32(struct opu_process_device *pdd)
{
	return (pdd->lds_base >> 16) & 0xFF;
}

static inline unsigned int
get_sh_mem_bases_nybble_64(struct opu_process_device *pdd)
{
