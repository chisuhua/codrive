...
/// Class representing the command-line 
class CommandLine
{
...
public:
	...
	/// Return the program name. The command line
	...
	void Register(const std::string &name, bool &variable,
			const std::string &help)
	{
		Register(utils::make_unique<CommandLineOptionBool>(name,
				&variable, help));
	}
	...
	void RegisterString(const std::string &name, std::string &variable,
			const std::string &help)
	{
		Register(utils::make_unique<CommandLineOptionString>(name,
				&variable, help));
	}
	...
	void RegisterInt32(const std::string &name, int &variable,
			const std::string &help)
	{
		Register(utils::make_unique<CommandLineOptionInt32>(name,
				&variable, help));
	}
	...
	void RegisterInt64(const std::string &name, long long &variable,
			const std::string &help)
	{
		Register(utils::make_unique<CommandLineOptionInt64>(name,
				&variable, help));
	}
	...
	void RegisterDouble(const std::string &name,
			...
			const std::string &help)
	{
		Register(utils::make_unique<CommandLineOptionDouble>(name,
	...
	{
		Register(utils::make_unique<CommandLineOptionEnum>(name,
				&variable, map, help));
	}
